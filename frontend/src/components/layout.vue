<template>
    <div>
      <nav class="fixed top-0 z-50 w-full bg-purple-500 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 mb-6">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              <a href="/" class="flex ms-2 md:me-24">
                <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white text-white">Data Analysis</span>
              </a>
            </div>
          </div>
        </div>
          ...
          <ul class="space-y-2 font-medium">
            <li v-for="link in links" :key="link.id">
              <a :href="link.url" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg :class="link.iconClasses" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="p-4 sm:ml-64 bg-purple-50 h-[100vmin] mt-16">
        <slot></slot>
      </div>
    </div>
  </template>
    ...
    data() {
      return {
        links: [
          ...
          { id: 3, url: "/crosstabs", label: "Crosstabs Calculation", iconClasses: "flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white", iconPath: "M17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377Z" },
